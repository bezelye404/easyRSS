...
This repository separates meta/project information from active development and build artifacts:

| Branch | Description |
| :--- | :--- |
| `main` | Project documentation, release notes, license, and public repository metadata. |
| Development branches | Active source code, Xcode project configuration, and ongoing feature developments. |
